// -*- C++ -*-
//
// KimNeighborNEIGHPUREF.cpp: Kim pure full neighbor list.
//
                                                              ...
                                                              double rCut)
{
  ...
  self->weakrefs = NULL;
  self->fulllist = false;
  self->cobj = new KimNeighborNEIGHPUREF(pkim, atoms, rCut);
  if (self->cobj == NULL)
    {
      CHECKREF(self);
      Py_DECREF(self);
...
int KimNeighborNEIGHPUREF::GetFullNeighbors(int n, int *neighbors, Vec *diffs, double *diffs2,
