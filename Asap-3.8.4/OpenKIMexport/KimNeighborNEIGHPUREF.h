// -*- C++ -*-
//
// KimNeighborNEIGHPUREF.h: Kim pure full neighbor list.
//
...
#ifndef KIMNEIGHBORNEIGHPUREF_H
#define KIMNEIGHBORNEIGHPUREF_H

#include "KimNeighborNEIGHPUREH.h"

namespace ASAPSPACE {

PyAsap_NeighborLocatorObject *PyAsap_NewKimNeighborNEIGHPUREF(intptr_t* pkim,
                                                              KimAtoms *atoms,
                                                              double rCut);

class KimNeighborNEIGHPUREF : public KimNeighborNEIGHPUREH
{
protected:
  KimNeighborNEIGHPUREF(intptr_t* pkim, KimAtoms *atoms, double rCut) :
    KimNeighborNEIGHPUREH(pkim, atoms, rCut) {};

  friend PyAsap_NeighborLocatorObject *PyAsap_NewKimNeighborNEIGHPUREF(intptr_t *pkim,
                                                                       KimAtoms *atoms,
                                                                       double rCut);
...
public:
  ...
  virtual int GetNeighbors(int n, int *neighbors, Vec *diffs, double *diffs2,
    ...
    {throw AsapError("Trying to use an OpenKIM full neighbor list as a half list (KimNeighborNEIGHPUREF)");}
